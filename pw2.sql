...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2024 a las 01:15:23
...
INSERT INTO `pregunta` (`idPregunta`, `descripcion`, `categoria`, `correcto`, `incorrecto`, `fechaCreacion`) VALUES
                                                                                                                 (1, '¿Cuál es el planeta más grande del sistema solar?', 1, 11, 1, '2024-11-16'),
                                                                                                                 (2, '¿Cuál es el río más largo del mundo?', 2, 7, 3, '2024-09-16'),
                                                                                                                 (3, '¿Cuál es el planeta más cercano al Sol?', 1, 13, 5, '2020-11-16'),
                                                                                                                 (4, '¿Qué gas es necesario para la respiración humana?', 1, 11, 7, '2020-11-16'),
                                                                                                                 (5, '¿Cuál es la capital de Japón?', 2, 14, 4, '2023-11-16'),
                                                                                                                 (6, '¿En qué continente se encuentra Egipto?', 2, 16, 3, '2024-11-23'),
                                                                                                                 (7, '¿Quién fue el primer presidente de los Estados Unidos?', 3, 14, 4, '2024-11-23'),
                                                                                                                 (8, '¿En qué año comenzó la Segunda Guerra Mundial?', 3, 13, 3, '2024-11-16'),
                                                                                                                 (9, '¿Cuántos jugadores tiene un equipo de fútbol en el campo?', 4, 15, 1, '2024-11-16'),
                                                                                                                 (10, '¿En qué deporte se utiliza una pelota de 3 agujeros?', 4, 15, 46, '2024-11-16'),
                                                                                                                 (11, '¿Quién pintó la Mona Lisa?', 5, 17, 54, '2024-11-16'),
                                                                                                                 (12, '¿A qué movimiento artístico pertenece el cuadro \"La noche estrellada\"?', 5, 15, 47, '2024-11-16'),
                                                                                                                 (27, 'En que parte se encuentra el obelisco', 2, 11, 50, '2024-11-16');
...
--
ALTER TABLE `partida`
    MODIFY `idPartida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
